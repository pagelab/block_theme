<section <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array('class' => "bg-gray-800 not-prose py-16 md:py-24", ) ); else echo 'data-wp-block-props="true"'; ?>>
  <div class="container mx-auto px-4">
    <div class="flex flex-col overflow-hidden rounded-xl shadow-lg lg:flex-row">
      ...
      <div class="bg-gray-700 p-8 md:p-10 lg:w-3/5">
        ...
        <div role="tablist" class="flex flex-wrap md:flex-nowrap mb-10 rounded-lg overflow-hidden">
          <button role="tab" aria-selected="false" class="flex-1 py-4 px-2 bg-gray-800 text-gray-400 hover:bg-gray-700 hover:text-gray-200 transition-colors focus-visible:outline-white focus-visible:outline-2">
            <?php _e( 'Starter', 'block_theme' ); ?>
          </button>
          <button role="tab" aria-selected="false" class="flex-1 py-4 px-2 bg-gray-800 text-gray-400 hover:bg-gray-700 hover:text-gray-200 transition-colors focus-visible:outline-white focus-visible:outline-2">
            <?php _e( 'Standard', 'block_theme' ); ?>
          </button>
          <button role="tab" aria-selected="false" class="flex-1 py-4 px-2 bg-gray-800 text-gray-400 hover:bg-gray-700 hover:text-gray-200 transition-colors focus-visible:outline-white focus-visible:outline-2">
      ...
      <div class="bg-gray-700 flex flex-col p-8 md:p-10 lg:w-2/5">
        ...
        <a href="#" class="inline-flex items-center mb-4 text-blue-400 hover:underline">
          <?php _e( 'View team pricing', 'block_theme' ); ?> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" version="1.1"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
        </a>
        
        <p class="text-xs text-gray-400 mt-auto">
          <?php _e( '*To see the monthly email send limit included with your specific plan, click Calculate my price. If your plan\'s contact or email send limit is exceeded, you will be charged for overages.', 'block_theme' ); ?>
        </p>
      </div>
    </div>
  </div>
